...
def build(image_set, args):
    ...
    PATHS = {
        "train": (root / "data/images/train2014/", root / "data/vcoco" / 'vcoco_trainval.json'),
        "val": (root / "data/images/test2014", root / "data/vcoco" / 'vcoco_test.json'),
        "test": (root / "data/images/test2014", root / "data/vcoco" / 'vcoco_test.json'),
    }
